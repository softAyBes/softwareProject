			...
			if (stat.equalsIgnoreCase("admin")) {
				while (logged == 1) {
					...
					if (x == 1) {
						...
						x = input.nextInt();
						if (x == 1) {
							logger.log(Level.INFO, "Total number of products {} ",
									Main.itemsNum(Main.customers));
							logger.log(Level.INFO, "\n");
							logger.log(Level.INFO, "\n");

						} else if (x == 2) {
							logger.log(Level.INFO, "Total number of waiting products is {} ",
							...
							logger.log(Level.INFO, "Total number of Money {} ",
									Main.totalMoney(Main.customers));
							logger.log(Level.INFO, "\n");
							logger.log(Level.INFO, "\n");

						} else if (x == 5) {
							logger.log(Level.INFO, "Total number of debts {}",
